...
module.exports = {
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '91919148446510@s.whatsapp.net' : process.env.TAG_REPLY,
    NBSK: process.env.ALL_NUMBER === undefined ? '919148446510' : process.env.ALL_NUMBER,
    ...
    SUPPORT2: "919148446510",
    SUPPORT3: "919148446510"
};
